#!/usr/bin/env python3
"""Issue the closed, zero-trial FMB1 Zero-Perturbation exec-r2 lock."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    output = args.output_dir or root / R2_RESULTS_DIR
    lock, inventory = build_exec_r2_lock(
        root,
        execution_code_commit=args.execution_code_commit,
        issued_at_utc=args.issued_at_utc,
    )
    report = write_exec_r2_lock(root, output, lock, inventory)
